...
public class game_interactions2 {
	...
	public void start() {
		...
		System.out.println("Welcome to the Gory Gardens Game! In secret the RHS has been developing a new type of plant food" + "\n" 
	...
	public void roseGarden() {
			...
			// if they chose to use a weapon then depending on the character chosen they will have a different outcome
	...
	public void Greenhouse() {
			...
			//depending on choice made the outcome will be different depending on the character chosen
			
			if (inputChoice.equals ("a")) {
				
				if (inputCharacter.equals ("1")) {
					
					System.out.println("You tried to attack using the sacetuers but they were too small to do any real damage." + "/n" 
